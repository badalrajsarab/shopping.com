...
/**
 * Servlet implementation class updateoffer
 */
...
public class updateoffer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "UPDATE offerzone SET name=?, image_url=?, price=?, quantity=?, description=?, manufacturing_date=?, expiry_date=? WHERE id=?";
            ...
            if (rowsUpdated > 0) {
                response.sendRedirect("offerzone2.jsp?message=Product updated successfully");
