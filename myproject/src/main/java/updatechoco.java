...
@WebServlet("/updatechoco")
public class updatechoco extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/update_choco.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "UPDATE choco SET name=?, image_url=?, price=?, quantity=?, description=?, manufacturing_date=?, expiry_date=? WHERE id=?";
            ...
            if (rowsUpdated > 0) {
                response.sendRedirect("choco.jsp?message=Product updated successfully");
